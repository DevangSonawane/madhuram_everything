...
class _ChallanDetailPageState extends State<ChallanDetailPage> {
  ...
  Future<void> _save() async {
    ...
    final payload = {
      'project_id':
          int.tryParse(_challan!.projectId ?? '') ?? _challan!.projectId,
  ...
  void _openMIR() {
    if (_challan == null) return;
    context.appPush('/mir', extra: {'challan_number': _challan!.challanNumber});
  }

  void _openITR() {
    if (_challan == null) return;
    context.appPush('/itr', extra: {'challan_number': _challan!.challanNumber});
  }
  ...
  Widget build(BuildContext context) {
    ...
    final isCompact = responsive.screenWidth < Breakpoints.desktop;
              ...
              child: Padding(
                ...
                child: _loading
                    ...
                    : Column(
                        ...
                        children: [
                          Text(
                            'Challan #${_challan!.challanNumber}',
                            ...
                            children: [
                              ...
                              if (_attachmentPath.isNotEmpty)
                                MadButton(
                                  ...
                                  onPressed: () =>
                                      _openAttachment(_attachmentPath),
                                ),
                              if (_attachmentPath.isNotEmpty)
                                Text(
                                  _attachmentPath,
                                          ...
                                          if (isCompact)
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                MadInput(
                                                  labelText: 'Width',
                                                  controller: _items[i].width,
                                                ),
                                                const SizedBox(height: 12),
                                                MadInput(
                                                  labelText: 'Length',
                                                  controller: _items[i].length,
                                                ),
                                                const SizedBox(height: 12),
                                                Align(
                                                  alignment:
